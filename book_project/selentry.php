<?php
 ...
 $get_list_sql = "SELECT master_id,CONCAT_WS(', ', l_name, f_name) AS display_name FROM master_name ORDER BY l_name, f_name";
 ...
 //get master_info
 $get_master_sql = "SELECT concat_ws(' ',f_name,l_name) as display_name FROM master_name WHERE master_id = '".$safe_id."'";
