...
if(!$_POST){
    ...
    <input type="number"  name="tel_number" size="30" maxlength="25" />
...
END_OF_TEXT;
 ...
 elseif($_POST){
       ...
       if($_POST['tel_number']){
           ...
           $add_tel_sql="INSERT INTO telephone(master_id,date_added,date_modified,tel_number,type)VALUES('".$_master_id."',now(),now(),'".$safe_tel_number."','".$tel_type."')";
